import { e as createComponent, g as addAttribute, o as renderHead, p as renderSlot, r as renderTemplate, h as createAstro } from './astro/server_BTgz9LB2.mjs';
import 'piccolore';
import 'clsx';
/* empty css                         */

const getLangFromPath = (pathname) => pathname.startsWith("/en") ? "en" : "es";
const getSwitchHref = (pathname) => {
...
const t = (lang) => {
  const es = {
    layout: {
      ...
      descDefault: "Experimenta una noche de glamping de lujo bajo el cielo más limpio del Valle del Colca, en Arequipa, Perú."
    },
    header: {
    ...
    hero: {
      ...
      body: "Descubre noches silenciosas, domos geodésicos de diseño y cielos perfectos para astrofotografía en Arequipa. Una experiencia privada, íntima y extraordinaria.",
    ...
    prebook: {
      ...
      body: "Primero consultamos disponibilidad real y luego generamos tu solicitud por WhatsApp con fechas y cantidad de huéspedes.",
      name: "Nombre",
      ...
      statusNoStock: "No hay disponibilidad para esas fechas. Escríbenos por WhatsApp para sugerirte alternativas.",
    ...
    footer: {
      about: "Glamping de lujo y noches de astrofotografía en el Valle del Colca, Arequipa, Perú.",
      explore: "Explora",
      contact: "Contacto",
      home: "Inicio",
    ...
    page: {
      ...
      homeDesc: "Vive una experiencia de glamping de lujo en Colca Star Domes: noches de cielo profundo, domos exclusivos y confort premium en el Valle del Colca."
    }
  };
  const en = {
    layout: {
      titleDefault: "Colca Star Domes | Luxury glamping under the stars",
      descDefault: "Experience luxury glamping under the cleanest skies in the Colca Valley, Arequipa, Peru."
    },
    header: {
    ...
    hero: {
      ...
      body: "Discover quiet nights, design geodesic domes, and skies made for astrophotography in Arequipa. A private, intimate, extraordinary experience.",
    ...
    prebook: {
      ...
      body: "We first check real availability, then create your WhatsApp request with dates and number of guests.",
      name: "Name",
    ...
    page: {
      ...
      homeDesc: "Live a luxury glamping experience at Colca Star Domes: deep-sky nights, exclusive domes, and premium comfort in the Colca Valley."
    }
  };
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  const tr = t(lang);
  const {
    title = tr.layout.titleDefault,
    description = tr.layout.descDefault
  } = Astro2.props;
  return renderTemplate`<html${addAttribute(lang, "lang")} class="scroll-smooth"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="description"${addAttribute(description, "content")}><title>${title}</title><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="icon" href="/favicon.ico"><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:type" content="website"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700&display=swap" rel="stylesheet">${renderHead()}</head> <body class="min-h-screen bg-night text-sillar font-sans antialiased"> <main class="flex min-h-screen flex-col pb-24"> ${renderSlot($$result, $$slots["default"])} </main> </body></html>`;
}, "C:/Users/rodri/colca-domes/src/layouts/Layout.astro", void 0);

export { $$Layout as $, getSwitchHref as a, getLangFromPath as g, t };
