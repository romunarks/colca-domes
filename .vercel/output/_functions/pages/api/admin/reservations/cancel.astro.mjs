...
import { d as cancelReservation } from '../../../../chunks/booking__DvAXFC1.mjs';
...
const POST = async ({ request }) => {
  ...
  try {
    ...
    const updated = await cancelReservation(supabase, reservationId);
    ...
    return new Response(
      JSON.stringify({ ok: false, message: error instanceof Error ? error.message : "No se pudo cancelar." }),
